...
// ============================================
// 🎯 FIX: TOGGLE DROPDOWN (Safe Event / Element Check)
// ============================================
function toggleDropdown(e) {
    // 1. Cek apakah 'e' adalah objek Event sebelum panggil preventDefault/stopPropagation
    ...
    // 2. Tentukan elemen yang diklik/toggle
    let triggerEl = null;

    if (e instanceof HTMLElement) {
        // Jika dipanggil via onclick="toggleDropdown(this)"
        triggerEl = e;
    } else if (e && e.currentTarget instanceof HTMLElement) {
        // Jika dipanggil via addEventListener
        triggerEl = e.currentTarget;
    } else if (e && e.target instanceof HTMLElement) {
        triggerEl = e.target;
    } else if (typeof e === 'string') {
        // Jika dipanggil via ID string
        triggerEl = document.getElementById(e);
    }

    if (!triggerEl) return;

    // 3. Cari kontainer dropdown atau trigger
